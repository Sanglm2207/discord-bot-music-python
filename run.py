...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.online, activity=discord.Game(name="Tao là xịn nhất server này nên hãy chơi tao đi :D, type {}help".format(config.BOT_PREFIX)))
